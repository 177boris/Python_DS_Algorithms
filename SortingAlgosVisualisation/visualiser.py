...
class Visualiser:
    ...
    def __init__(self):
        ...
        self.graph_width, self.graph_height = 1400, 700  # ui window width and height
        ...
        self.colours = ['#FFF', '#3a3a3a', '#2F7AE5', '#797EF6', '#4ADEDE', '#1AA7EC']
    ...
    def config_root(self):
        ...
        self.root.title('Sorting Algorithms Visualiser')  # set window title
    ...
    def config_menu(self):
        ...
        # create run button, reset button and quit button
        ttk.Button(self.menu_frame, text='Visualise', command=self.validate_setup)
        ttk.Button(self.menu_frame, text='Refresh', command=self.clean_canvas)
        ttk.Button(self.menu_frame, text='Quit', command=self.exit_program)
    ...
    def validate_setup(self):
        ...
        Solve(self.bars, self.n_bars, self.solve_mode, self)
...
# Program Driver for sorting visualiser
